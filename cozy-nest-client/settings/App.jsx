...
export function App() {
  ...
  function applySettings() {
    ...
    //TODO NEVYSHA quick fix - remove this
    // compare deep equality of _applySettings and config
    if (JSON.stringify(_applySettings) === JSON.stringify(config)) {
      return
    }
    _applySettings = config


    //TODO NEVYSHA - rework config live update
